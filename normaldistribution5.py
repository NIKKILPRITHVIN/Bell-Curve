...
print("mean,medin and mode of height is {},{} and {} respectively".format(height_mean,height_median,height_mode))
print("mean,medin and mode of wieght is {},{} and {} respectively".format(weight_mean,weight_median,weight_mode))
